...
public class TestBabyBook extends TestCase{
	...
	public void testUserBabyBook()  {
		...
		Picture pic1 = new Picture(null, null, "MyPhoto.jpg", "Paris", "Me and the girls in Paris");
		Picture pic2 = new Picture(null, null, "Pic.gif", "Home", "Playing in front of the fire");
		...
		Event event1 = new Event(null, "something", "My Event", "At home", "Some short description", new Date(), EventType.SAYINGS, null);
		Event event2 = new Event(null, "something", "Another Event", "In the park", "Another short description", new Date(), EventType.FIRST_STEPS, null);
		eventService.insertEvent(event1);
		eventService.insertEvent(event2);

		Picture pic3 = new Picture(null, null, "WithEvent.gif", "Event Pic", "Picture for the event");
		...
		Event event3 = new Event(null, null, "Another1 Event", "In the park", "Another short description", new Date(), EventType.FIRST_STEPS, null);
		eventService.insertEvent(event3);
		user.addEvent(event3);
		userService.updateUser(user);

		Page page = new Page(null, null, "page name", "Page description", new Date(), new Date(), null);
